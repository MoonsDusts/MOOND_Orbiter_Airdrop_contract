...
contract Airdrop is Ownable {
    ...
    uint256 public constant AIRDROP_AMOUNT = 33082581285212259141440;
    ...
    function setAirdropData(AirdropData[] memory _data) external onlyOwner {
        require(startAirdropTime == 0, "Airdrop: already started");
